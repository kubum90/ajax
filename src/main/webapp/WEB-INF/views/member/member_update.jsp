...
<div class="container" style="width: 60%">
	<div class="row main">
		...
		<div class="main-login main-center">
			<form id="memberUpdate" class="form-horizontal">
					...
					<div class="cols-sm-10">
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-user fa"
								...
								name="name" id="update_name" value="${student.name}"
								readonly="readonly" />
						</div>
					</div>
				</div>
					...
					<div class="cols-sm-10">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								type="text" class="form-control" name="email" id="update_email"
								value="${student.email}" />
						</div>
					</div>
				</div>
					...
					<div class="cols-sm-10">
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-users fa"
								aria-hidden="true"></i></span> <input type="text" class="form-control"
								name="phone" id="update_phone" value="${student.phone}" />
						</div>
					</div>
				</div>
					...
					<div class="cols-sm-10">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								name="origin_password" id="origin_password" type="password"
				...
				<div class="form-group">
					...
					<div class="cols-sm-10">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="fa fa-lock fa-lg" aria-hidden="true"></i></span> <input
								name="confirm" id="confirm" type="password" class="form-control"
